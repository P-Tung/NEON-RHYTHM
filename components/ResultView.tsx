...
const ResultView: React.FC<ResultViewProps> = ({
  ...
  return (
    <div className="flex flex-col items-center relative gap-2 md:gap-4 pb-48">
      ...
      <div
        className="fixed bottom-28 left-0 right-0 z-50 flex flex-col items-center px-4 animate-slide-up-pop pb-[env(safe-area-inset-bottom)]"
        style={{
